...
export const ACTIVITY_SOURCE_OPTIONS: FilterOption[] = [
    ...
    { value: "4161861381", label: "Raid: Reprised Version" },
    ...
    { value: "1537575125", label: "Challenge of the Elders" },
    ...
    { value: "2659839637", label: "DLC: The Taken King" },
    { value: "2964550958", label: "DLC: Rise of Iron" },
    { value: "3068521220", label: "Age of Triumph" },
