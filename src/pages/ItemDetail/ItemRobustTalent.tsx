...
export default function ItemRobustTalent({itemTalentHash = 0, itemType = 0}:{itemTalentHash:number, itemType:number}){
    ...
    function renderNodeDotMap(nodeArray:talentGridNode[]){
       ...
       return (
            <div className='talent-dotmap-container' aria-hidden>
                {columnElements}
            </div>
       )
    }
    ...
    function renderTalentGrid(nodeArray:talentGridNode[]){
       ...
       return (
            <div className='talent-grid-container' aria-hidden>
                {columnElements}
            </div>
       )
    }
                    ...
                    {itemHasChroma && 
                        <div className="chroma-link-box">
                            <div className='chroma-link-icon'>
                                <img src={'/data/d1_icons/img/destiny_content/items/multi-chroma-icon.png'} />
                            </div>
